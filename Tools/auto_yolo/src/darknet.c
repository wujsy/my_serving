...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        test_detector("/home/ypzhang/workspace/autohome/work/online_serving/Tools/auto_yolo/cfg/coco.data"
                      , argv[2], argv[3], filename, thresh, .5
                      , "/home/ypzhang/Desktop/test.jpeg", 0);
